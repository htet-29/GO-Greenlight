...
// failedValidationResponse is used to send a 422 Unprocessable Entity status code
// and JSON response to the client
func (app *application) failedValidationResponse(w http.ResponseWriter, r *http.Request, errors map[string]string) {
	app.errorResponse(w, r, http.StatusUnprocessableEntity, errors)
}

// editConflictResponse is used to send a 409 Conflict status code
// and JSON response to the client
...
// rateLimitExceededResponse is used to send a 429 Too Many Request status code
// and JSON response to the client
...
// invalidCredentialsResponse is used to send a 401 Unauthorized status code
// and JSON response to the client
...
// invalidAuthenticationTokenResponse is used to send a 401 Unauthorized status code
// and JSON response to the client
...
// authenticationRequiredResponse is used to send a 401 Unauthorized status code
// and JSON response to the client
...
// invalidCredentialsResponse is used to send a 403 Forbidden status code
// and JSON response to the client
